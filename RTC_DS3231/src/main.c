...
//	{
//		uint8_t control;
//		i2c_temp_write_reg(I2C2,DS3231_CONTROL_REG, DS3231_CONTROL_RS2 | DS3231_CONTROL_RS1 | DS3231_CONTROL_INTCN);
//		i2c_temp_read_register(I2C2,DS3231_CONTROL_REG, &control);
//
...
//	}
	...
	while(1){
		i2c_temp_read_registers(I2C2,0x00, data, 19);
